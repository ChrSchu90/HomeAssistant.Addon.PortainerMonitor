...
public class V1beta1PodMetrics {
    ...
    /// </summary>
    /// <value>Metrics for all containers are collected within the same time window.</value>
    [JsonPropertyName("containers")]
    public List<V1beta1ContainerMetrics> Containers { get; set; }
    ...
    /// </summary>
    /// <value>The following fields define time interval from which metrics were collected from the interval [Timestamp-Window, Timestamp].</value>
    ...
    public V1Duration Window { get; set; }
