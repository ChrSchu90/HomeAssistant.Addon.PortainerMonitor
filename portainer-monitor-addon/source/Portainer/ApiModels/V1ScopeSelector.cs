...
public class V1ScopeSelector {
    ...
    /// </summary>
    /// <value>A list of scope selector requirements by scope of the resources. +optional</value>
    [JsonPropertyName("matchExpressions")]
    public List<V1ScopedResourceSelectorRequirement> MatchExpressions { get; set; }
