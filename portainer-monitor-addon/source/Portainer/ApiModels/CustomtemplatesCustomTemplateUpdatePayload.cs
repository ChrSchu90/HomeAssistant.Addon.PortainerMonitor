...
/// 
/// </summary>
public class CustomtemplatesCustomTemplateUpdatePayload {
    /// <summary>
    ...
    /// </summary>
    /// <value>GitCredentialID used to identify the bound git credential. Required when RepositoryAuthentication is true and RepositoryUsername/RepositoryPassword are not provided</value>
    [JsonPropertyName("repositoryGitCredentialID")]
    public int? RepositoryGitCredentialID { get; set; }

    /// <summary>
    /// Password used in basic authentication. Required when RepositoryAuthentication is true and RepositoryGitCredentialID is 0
    /// </summary>
    /// <value>Password used in basic authentication. Required when RepositoryAuthentication is true and RepositoryGitCredentialID is 0</value>
    ...
    /// </summary>
    /// <value>Username used in basic authentication. Required when RepositoryAuthentication is true and RepositoryGitCredentialID is 0</value>
    ...
    public override string ToString()  {
        ...
        sb.Append("class CustomtemplatesCustomTemplateUpdatePayload {\n");
        ...
        sb.Append("  RepositoryGitCredentialID: ").Append(RepositoryGitCredentialID).Append("\n");
