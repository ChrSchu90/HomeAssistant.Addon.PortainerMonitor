...
public class V2ObjectMetricSource {
    ...
    /// </summary>
    /// <value>describedObject specifies the descriptions of a object,such as kind,name apiVersion</value>
    ...
    public override string ToString()  {
        ...
        sb.Append("  DescribedObject: ").Append(DescribedObject).Append("\n");
