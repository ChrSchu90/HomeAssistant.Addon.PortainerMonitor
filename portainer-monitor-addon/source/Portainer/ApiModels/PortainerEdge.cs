...
/// 
/// </summary>
public class PortainerEdge {
    /// <summary>
    /// Deprecated 2.18
    /// </summary>
    /// <value>Deprecated 2.18</value>
    ...
    /// </summary>
    /// <value>The command list interval for edge agent - used in edge async mode (in seconds)</value>
    ...
    /// </summary>
    /// <value>The ping interval for edge agent - used in edge async mode (in seconds)</value>
    ...
    /// </summary>
    /// <value>The snapshot interval for edge agent - used in edge async mode (in seconds)</value>
