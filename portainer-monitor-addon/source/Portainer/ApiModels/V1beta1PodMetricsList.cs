...
public class V1beta1PodMetricsList {
    ...
    /// List of pod metrics.
    /// </summary>
    /// <value>List of pod metrics.</value>
    [JsonPropertyName("items")]
    public List<V1beta1PodMetrics> Items { get; set; }
