...
/// 
/// </summary>
public class KubernetesK8sRole {
    /// <summary>
    ...
    /// </summary>
    /// <value>isSystem is true if prefixed with \"system:\" or exists in the kube-system namespace or is one of the portainer roles</value>
    ...
    public override string ToString()  {
        ...
        sb.Append("class KubernetesK8sRole {\n");
